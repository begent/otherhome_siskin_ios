...
class BaseChatViewController: UIViewController, UITextViewDelegate, ChatViewInputBarDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        chatViewInputBar.placeholder = String.localizedStringWithFormat(NSLocalizedString("Send message", comment: "conversation view input field placeholder"), conversation.account.stringValue);
